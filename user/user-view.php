            ...
            <div class="row">
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form novalidate="">
                        ...
                        <button type="submit" value="<?php echo $data['id']; ?>" name="accept" class="btn btn-success" title="View Profile">Accept</button>

                        <!-- Reject button -->
                        <button type="submit" value="<?php echo $data['id']; ?>" name="reject" class="btn btn-danger" title="View Profile">Reject</button>
